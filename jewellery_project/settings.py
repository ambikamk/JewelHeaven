...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Customers", "url": "http://127.0.0.1:8000/admin/jewellery_app/customer/", "new_window": False},

        # external url that opens in a new window (Permissions can be added)
        {"name": "Products", "url": "http://127.0.0.1:8000/admin/jewellery_app/product/", "new_window": False},
...
"custom_links": {
    ...
    "site_brand": "Jewel Heaven",
    "welcome_sign": "Welcome to the AdminDashboard",
    "copyright": "JewelHeaven",
     "icons": {
